...
{
    const char* pszTimestamp = "Washington Post 12/Aug/2021 Google’s new ‘time crystals’ could be a breakthrough for long-awaited quantum computers";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1628806833, 2002534221, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8b3c6afbde57e0161d20ac65ea241d5201895456d79fa0ab747c171ec7560dce"));
        assert(genesis.hashMerkleRoot == uint256S("0xef5eecdb100423a2e46871fb2e01f46ac1d443402bf80e4f393a7e2de00c6e07"));
        ...
        //vSeeds.emplace_back("seed-a.bharatcoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.bharatcointools.com");
        //vSeeds.emplace_back("dnsseed.bharatcoinpool.org");
        ...
        checkpointData = {
            {
                {     0, uint256S("0x8b3c6afbde57e0161d20ac65ea241d5201895456d79fa0ab747c171ec7560dce")},
                /*
...
public:
    CTestNetParams() {
        ...
        //vSeeds.emplace_back("testnet-seed.bharatcointools.com");
        //vSeeds.emplace_back("seed-b.bharatcoin.loshan.co.uk");
