...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bharatcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bharatcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bharatcoin transaction\n" +
            "or:     bharatcoin-tx [options] -create [commands]   Create hex-encoded bharatcoin transaction\n" +
            "\n";
