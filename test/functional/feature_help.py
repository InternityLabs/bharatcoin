...
"""Verify that starting bharatcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bharatcoin with -h for help text")
        ...
        self.log.info("Start bharatcoin with -version for version information")
        ...
        self.log.info("Start bharatcoind with -fakearg to make sure it does not start")
