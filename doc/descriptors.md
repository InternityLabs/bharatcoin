# Support for Output Descriptors in Bharatcoin Core

Since Bharatcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Bharatcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bharatcoin Core wallets, a convenience function `combo` is
